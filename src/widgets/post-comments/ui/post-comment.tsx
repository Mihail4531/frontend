...
export const PostComments = ({ postId }: { postId: number }) => {
  const { comments, commentTree, isLoading, handleOptimisticAdd, handleDeleteComment } = usePostComments(postId);
  ...
  return (
    <div className="mt-20 pt-10 border-t border-white/5" id="comments">
      ...
      <AddCommentForm postId={postId} onCommentAdded={handleOptimisticAdd} />
