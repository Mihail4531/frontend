...
export const PopularTags = ({ tags }: Props) => {
 ...
 const currentTag = searchParams?.get("tag");
  ...
  return (
    <div className="bg-zinc-900/20 border border-white/5 rounded-xl flex flex-col h-full max-h-[calc(100vh-120px)] sticky top-24">
         <div className="p-5 pb-3 border-b border-white/5 shrink-0">
      ...
      <div className="p-5 pt-4 border-t border-white/5 bg-zinc-900/40 rounded-b-xl shrink-0 backdrop-blur-sm">
     ...
     <ul className="text-xs flex-col flex gap-2.5 text-zinc-500 font-mono">
  <li>
    <span className="block text-zinc-300 opacity-70">Dev Community</span>
      </li>
      <li>
    <span className="block text-zinc-300 opacity-70">Платформа для разработчиков.</span>
</li>
  <li>
    <Link href={APP_ROUTE.rules()} className="hover:text-red-400 text-zinc-300 opacity-70 block">
      Правила сообщества
    </Link>
  </li>
</ul>
